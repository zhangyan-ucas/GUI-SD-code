#!/bin/bash
cd /mnt/vlm-ks3/zhangyan/cvpr_code/ms-swift-qwen3vl/
...
output_path="/mnt/vlm-ks3/zhangyan/datasets/nips_data/useful_output/venus15/screenspotpro/2b_1infer.jsonl"
ckpt="/mnt/vlm-ks3/zhangyan/pretrained_models/hf/inclusionAI/UI-Venus-1.5-2B"
