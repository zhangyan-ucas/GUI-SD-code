...
python /mnt/vlm-ks3/zhangyan/nips_code/opd/synth_pipeline/scalecua/merge_jsonl.py \
    -i \
    ...
    "/mnt/vlm-ks3/zhangyan/datasets/nips_data/swift_data/scalecua/250328/250328_filter.jsonl" \
    ...
    -o "/mnt/vlm-ks3/zhangyan/datasets/nips_data/swift_data/version_data/${run_name}.jsonl"
...
swift sft \
    ...
    --model_type "qwen3_vl" \
    --train_type full \
    --dataset "/mnt/vlm-ks3/zhangyan/datasets/nips_data/swift_data/version_data/${run_name}.jsonl" \
