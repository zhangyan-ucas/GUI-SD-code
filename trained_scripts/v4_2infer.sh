...
swift rlhf \
    --rlhf_type gkd \
    --use_opsd true \
    --opsd_mask_dir "/vlm-ssd/zhangyan/cache/opd_cache/260309" \
    --model /mnt/vlm-ks3/zhangyan/pretrained_models/hf/inclusionAI/UI-Venus-1.5-2B \
    --model_type "qwen3_vl" \
    --teacher_model /mnt/vlm-ks3/zhangyan/pretrained_models/hf/inclusionAI/UI-Venus-1.5-2B \
    --teacher_model_type "qwen3_vl" \
    --train_type full \
    --dataset "/mnt/vlm-ks3/zhangyan/datasets/nips_data/swift_data/atlas/venus15_atlas_2b_2infer.jsonl" \
    --seq_kd false \
    --lmbda 1 \
    --beta 1 \
