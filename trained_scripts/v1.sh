...
swift rlhf \
    ...
    --model /mnt/vlm-ks3/zhangyan/pretrained_models/hf/inclusionAI/UI-Venus-1.5-2B \
    --model_type "qwen3_vl" \
    --teacher_model /mnt/vlm-ks3/zhangyan/pretrained_models/hf/inclusionAI/UI-Venus-1.5-8B \
    --teacher_model_type "qwen3_vl" \
    --train_type full \
    --dataset /mnt/vlm-ks3/zhangyan/datasets/nips_data/swift_data/atlas/venus15_atlas.jsonl \
    --seq_kd false \
    --lmbda 1 \
    --beta 1 \
