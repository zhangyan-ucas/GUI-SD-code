...
def main():
    ...
    for item in tqdm(meta_data.values(), desc="Processing meta.json sources"):
        ...
        anno2platform = {
            # "/mnt/vlm-ks3/zhangyan/datasets/source_pt/ScaleCUA-Data/annotations/data_20250421_Android_internvl_grounding_20250429.jsonl": "android",
            # "/mnt/vlm-ks3/zhangyan/datasets/source_pt/ScaleCUA-Data/annotations/data_20250421_web_internvl_grounding_20250505.jsonl:": "web",
