...
def main():
    ...
    for item in tqdm(meta_data.values(), desc="Processing meta.json sources"):
        ...
        anno2platform = {
            # "/mnt/vlm-ks3/zhangyan/datasets/source_pt/ScaleCUA-Data/annotations/data_20250505_android_internvl_grounding_20250506.jsonl": "android",
            "/mnt/vlm-ks3/zhangyan/datasets/source_pt/ScaleCUA-Data/annotations/data_20250505_windows_internvl_grounding_20250508_20250722.jsonl": "windows"
        }
