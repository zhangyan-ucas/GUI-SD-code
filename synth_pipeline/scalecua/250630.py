...
def main():
    ...
    for item in tqdm(meta_data.values(), desc="Processing meta.json sources"):
        ...
        anno2platform = {
            "/mnt/vlm-ks3/zhangyan/datasets/source_pt/ScaleCUA-Data/annotations/data_20250630_windows_data_20250630_internvl_grounding_20250630_20250722.jsonl": "windows",
            "/mnt/vlm-ks3/zhangyan/datasets/source_pt/ScaleCUA-Data/annotations/data_20250630_windows_data_20250703_internvl_grounding_20250703_20250722.jsonl": "windows",
            "/mnt/vlm-ks3/zhangyan/datasets/source_pt/ScaleCUA-Data/annotations/data_20250630_windows_internvl_grounding_20250627_20250722.jsonl": "windows",
        }
        ...
        with open(annotation_path, 'r') as f:
            ...
            for idx, line in enumerate(tqdm(lines, desc=f"Reading {annotation_path}")):
                ...
                if not os.path.exists(image_path):
                    image_path = image_path.replace("windows", "windows_data_20250630")
                ...
                if len(sample['gt']) == 4 and os.path.exists(image_path):
