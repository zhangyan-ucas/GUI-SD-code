...
def main():
    ...
    for item in tqdm(meta_data.values(), desc="Processing meta.json sources"):
        ...
        anno2platform = {
            "/mnt/vlm-ks3/zhangyan/datasets/source_pt/ScaleCUA-Data/annotations/data_20250623_windows_internvl_grounding_20250619_20250722.jsonl":"windows",
            "/mnt/vlm-ks3/zhangyan/datasets/source_pt/ScaleCUA-Data/annotations/data_20250623_windows_internvl_grounding_20250620_20250722.jsonl":"windows",
        }
