...
# output_path = "/mnt/vlm-ks3/zhangyan/datasets/nips_data/swift_data/atlas/sft.jsonl"
output_path = "/mnt/vlm-ks3/zhangyan/datasets/nips_data/swift_data/atlas/venus15_atlas_2b_2infer.jsonl"
...
with open(output_path, 'w', encoding='utf-8') as f_out:
    for idx, sample in enumerate(filter_data):
        swift_sample = opd_sample(sample, idx)
